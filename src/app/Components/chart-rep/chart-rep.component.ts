...
@Component({
  selector: 'app-chart-rep',
  standalone: true,
  imports: [],
  templateUrl: './chart-rep.component.html',
  styleUrl: './chart-rep.component.css'
})
export class ChartRepComponent {
   ...
   data: any[] = [];
     ...
     loadExcel() : void{
       ...
       const filePath = 'assets/excel/repairing.xlsx'; 
     ...
     assignValue(){
       this.chart = new Chart('c30' , this.chartinfo);
     }
